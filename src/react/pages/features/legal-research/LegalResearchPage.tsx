...
const LegalResearchPage: React.FC = () => {
  const subFeatures = subFeaturesData['legal-research'] || [];
    ...
    <div className="feature-page">
      <div className="feature-hero">
        <div className="container">
          <div className="feature-hero-content">
            ...
            <h1>Legal Research & Knowledge Base</h1>
            <p className="feature-subtitle">
              Comprehensive legal research & knowledge base tools and features for your law firm
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/legal-research/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Legal Research & Knowledge Base</h2>
          <p>Ready to streamline your legal research & knowledge base?</p>
