...
const CommunicationPage: React.FC = () => {
  const subFeatures = subFeaturesData['communication'] || [];
    ...
    <div className="feature-page">
        ...
        <div className="container">
          <div className="feature-hero-content">
            ...
            <p className="feature-subtitle">
              Comprehensive communication & collaboration tools and features for your law firm
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/communication/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Communication & Collaboration</h2>
          <p>Ready to streamline your communication & collaboration?</p>
