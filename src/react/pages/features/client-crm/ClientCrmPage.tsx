...
const ClientCrmPage: React.FC = () => {
  const subFeatures = subFeaturesData['client-crm'] || [];
    ...
    <div className="feature-page">
        ...
        <div className="container">
          <div className="feature-hero-content">
            ...
            <p className="feature-subtitle">
              Comprehensive client relationship management tools and features for your law firm
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/client-crm/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Client Relationship Management</h2>
          <p>Ready to streamline your client relationship management?</p>
