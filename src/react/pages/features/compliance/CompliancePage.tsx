...
const CompliancePage: React.FC = () => {
  const subFeatures = subFeaturesData['compliance'] || [];
    ...
    <div className="feature-page">
        ...
        <div className="container">
          <div className="feature-hero-content">
            ...
            <p className="feature-subtitle">
              Comprehensive compliance & risk management tools and features for your law firm
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/compliance/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Compliance & Risk Management</h2>
          <p>Ready to streamline your compliance & risk management?</p>
