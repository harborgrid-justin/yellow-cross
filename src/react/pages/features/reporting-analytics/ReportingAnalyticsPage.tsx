...
const ReportingAnalyticsPage: React.FC = () => {
  const subFeatures = subFeaturesData['reporting-analytics'] || [];
    ...
    <div className="feature-page">
        ...
        <div className="container">
          <div className="feature-hero-content">
            ...
            <p className="feature-subtitle">
              Comprehensive reporting & analytics tools and features for your law firm
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/reporting-analytics/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Reporting & Analytics</h2>
          <p>Ready to streamline your reporting & analytics?</p>
