/**
 * WF-COMP-TBD | DataPrivacyForm.tsx - DataPrivacy Form Component
...
interface DataPrivacyFormProps {
  ...
  onChange: (data: DataPrivacyFormData) => void;
  onSubmit: () => void;
  onCancel: () => void;
  errors?: Partial<DataPrivacyFormData>;
  loading?: boolean;
  submitLabel?: string;
}

const DataPrivacyForm: React.FC<DataPrivacyFormProps> = ({
  data,
  onChange,
  onSubmit,
  onCancel,
