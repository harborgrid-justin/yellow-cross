/**
 * WF-COMP-TBD | ContractManagementForm.tsx - ContractManagement Form Component
...
interface ContractManagementFormProps {
  data: ContractManagementFormData;
  onChange: (data: ContractManagementFormData) => void;
  onSubmit: () => void;
  onCancel: () => void;
  errors?: Partial<ContractManagementFormData>;
  loading?: boolean;
  submitLabel?: string;
}
