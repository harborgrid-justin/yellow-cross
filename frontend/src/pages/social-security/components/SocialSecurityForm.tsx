/**
 * WF-COMP-TBD | SocialSecurityForm.tsx - SocialSecurity Form Component
...
interface SocialSecurityFormProps {
  ...
  onChange: (data: SocialSecurityFormData) => void;
  onSubmit: () => void;
  onCancel: () => void;
  errors?: Partial<SocialSecurityFormData>;
  loading?: boolean;
  submitLabel?: string;
}

const SocialSecurityForm: React.FC<SocialSecurityFormProps> = ({
  data,
  onChange,
  onSubmit,
  onCancel,
