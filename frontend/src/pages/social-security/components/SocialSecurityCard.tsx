/**
 * WF-COMP-TBD | SocialSecurityCard.tsx - SocialSecurity Card Component
 * Purpose: Compact card display for social-security items
...
const SocialSecurityCard: React.FC<SocialSecurityCardProps> = ({ item, onView, onEdit, onDelete }) => {
  return (
