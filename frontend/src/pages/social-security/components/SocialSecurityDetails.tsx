/**
 * WF-COMP-TBD | SocialSecurityDetails.tsx - SocialSecurity Details Component
 * Purpose: Detailed information display for social-security item
...
interface SocialSecurityDetailsProps {
  item: SocialSecurityItem;
}

const SocialSecurityDetails: React.FC<SocialSecurityDetailsProps> = ({ item }) => {
  return (
