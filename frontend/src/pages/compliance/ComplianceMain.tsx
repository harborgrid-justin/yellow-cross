/**
 * WF-COMP-TBD | ComplianceMain.tsx - Compliance Main Page
 * Purpose: Main compliance management page with list view
...
// Main component
const ComplianceMain: React.FC = () => {
  const navigate = useNavigate();
  const dispatch = useAppDispatch();
  
  const items = useAppSelector(selectComplianceItems);
  ...
  useEffect(() => {
    void dispatch(fetchComplianceItems(undefined));
  }, [dispatch]);
  ...
  const handleCreate = () => {
    navigate('/pages/compliance/create');
  };
    ...
    <div className="p-6">
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage and monitor compliance items</p>
        </div>
        <button 
      ...
      <div className="bg-white rounded-lg shadow">
        {loading?.items && (
          <div className="flex items-center justify-center py-12">
            ...
            <span className="ml-2 text-gray-600">Loading compliance items...</span>
          </div>
        )}
        ...
        {error && (
          <div className="text-center py-12">
            ...
            <button 
              onClick={() => void dispatch(fetchComplianceItems(undefined))} 
