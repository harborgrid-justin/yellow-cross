/**
 * WF-COMP-TBD | SecurityCard.tsx - Security Card Component
 * Purpose: Compact card display for security items
...
const SecurityCard: React.FC<SecurityCardProps> = ({ item, onView, onEdit, onDelete }) => {
  return (
