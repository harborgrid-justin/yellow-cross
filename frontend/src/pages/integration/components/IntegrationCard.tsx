/**
 * WF-COMP-TBD | IntegrationCard.tsx - Integration Card Component
 * Purpose: Compact card display for integration items
...
const IntegrationCard: React.FC<IntegrationCardProps> = ({ item, onView, onEdit, onDelete }) => {
  return (
