/**
 * WF-COMP-TBD | EstatePlanningCard.tsx - EstatePlanning Card Component
 * Purpose: Compact card display for estate-planning items
...
interface EstatePlanningCardProps {
...
const EstatePlanningCard: React.FC<EstatePlanningCardProps> = ({ item, onView, onEdit, onDelete }) => {
  return (
