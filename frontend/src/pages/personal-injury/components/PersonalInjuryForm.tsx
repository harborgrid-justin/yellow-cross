/**
 * WF-COMP-TBD | PersonalInjuryForm.tsx - PersonalInjury Form Component
...
interface PersonalInjuryFormProps {
  data: PersonalInjuryFormData;
  onChange: (data: PersonalInjuryFormData) => void;
  onSubmit: () => void;
  onCancel: () => void;
  errors?: Partial<PersonalInjuryFormData>;
  loading?: boolean;
  submitLabel?: string;
}

const PersonalInjuryForm: React.FC<PersonalInjuryFormProps> = ({
  data,
  onChange,
  onSubmit,
  onCancel,
