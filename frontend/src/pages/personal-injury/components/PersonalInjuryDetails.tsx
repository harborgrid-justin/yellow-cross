/**
 * WF-COMP-TBD | PersonalInjuryDetails.tsx - PersonalInjury Details Component
 * Purpose: Detailed information display for personal-injury item
...
const PersonalInjuryDetails: React.FC<PersonalInjuryDetailsProps> = ({ item }) => {
  return (
