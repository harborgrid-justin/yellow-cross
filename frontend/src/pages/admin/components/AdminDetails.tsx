/**
 * WF-COMP-008 | AdminDetails.tsx - Admin Details Component
 * Purpose: Detailed information display for admin item
...
const AdminDetails: React.FC<AdminDetailsProps> = ({ item }) => {
  return (
