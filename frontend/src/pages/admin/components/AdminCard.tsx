/**
 * WF-COMP-006 | AdminCard.tsx - Admin Card Component
 * Purpose: Compact card display for admin items
...
const AdminCard: React.FC<AdminCardProps> = ({ item, onView, onEdit, onDelete }) => {
  return (
