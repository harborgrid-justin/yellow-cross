/**
 * WF-COMP-TBD | IntellectualPropertyDetails.tsx - IntellectualProperty Details Component
 * Purpose: Detailed information display for intellectual-property item
...
interface IntellectualPropertyDetailsProps {
  item: IntellectualPropertyItem;
}

const IntellectualPropertyDetails: React.FC<IntellectualPropertyDetailsProps> = ({ item }) => {
  return (
