/**
 * WF-COMP-TBD | IntellectualPropertyCard.tsx - IntellectualProperty Card Component
 * Purpose: Compact card display for intellectual-property items
...
interface IntellectualPropertyCardProps {
...
const IntellectualPropertyCard: React.FC<IntellectualPropertyCardProps> = ({ item, onView, onEdit, onDelete }) => {
  return (
