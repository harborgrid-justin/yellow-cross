/**
 * WF-COMP-TBD | IntellectualPropertyForm.tsx - IntellectualProperty Form Component
...
interface IntellectualPropertyFormProps {
  data: IntellectualPropertyFormData;
  onChange: (data: IntellectualPropertyFormData) => void;
  onSubmit: () => void;
  onCancel: () => void;
  errors?: Partial<IntellectualPropertyFormData>;
  loading?: boolean;
  submitLabel?: string;
}

const IntellectualPropertyForm: React.FC<IntellectualPropertyFormProps> = ({
  data,
  onChange,
  onSubmit,
  onCancel,
