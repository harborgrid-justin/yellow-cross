/**
 * WF-COMP-TBD | TaxLawCard.tsx - TaxLaw Card Component
 * Purpose: Compact card display for tax-law items
...
const TaxLawCard: React.FC<TaxLawCardProps> = ({ item, onView, onEdit, onDelete }) => {
  return (
