/**
 * WF-COMP-TBD | ClientCrmCard.tsx - ClientCrm Card Component
 * Purpose: Compact card display for client-crm items
...
const ClientCrmCard: React.FC<ClientCrmCardProps> = ({ item, onView, onEdit, onDelete }) => {
  return (
