/**
 * WF-COMP-TBD | CommunicationCard.tsx - Communication Card Component
 * Purpose: Compact card display for communication items
...
const CommunicationCard: React.FC<CommunicationCardProps> = ({ item, onView, onEdit, onDelete }) => {
  return (
