    ...
    <div className="feature-page">
      <div className="feature-hero">
        <div className="container">
          <div className="feature-hero-content">
            ...
            <h1>Data Privacy & GDPR</h1>
            <p className="feature-subtitle">
              Data privacy compliance and GDPR matters
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/data-privacy/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Data Privacy & GDPR</h2>
          <p>Ready to streamline your data privacy & gdpr?</p>
