    ...
    <div className="feature-page">
        ...
        <div className="container">
          <div className="feature-hero-content">
            ...
            <p className="feature-subtitle">
              Landlord-tenant disputes and housing law
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/landlord-tenant/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Landlord-Tenant</h2>
          <p>Ready to streamline your landlord-tenant?</p>
