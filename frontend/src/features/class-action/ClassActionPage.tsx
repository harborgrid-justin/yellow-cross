...
const ClassActionPage: React.FC = () => {
  const subFeatures = subFeaturesData['class-action'] || [];
    ...
    <div className="feature-page">
      <div className="feature-hero">
        <div className="container">
          <div className="feature-hero-content">
            <i className="fas fa-users-cog feature-icon"></i>
            <h1>Class Action</h1>
            <p className="feature-subtitle">
              Class action lawsuits and mass tort management
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/class-action/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Class Action</h2>
          <p>Ready to streamline your class action?</p>
