...
const FamilyLawPage: React.FC = () => {
  const subFeatures = subFeaturesData['family-law'] || [];
    ...
    <div className="feature-page">
        ...
        <div className="container">
          <div className="feature-hero-content">
            ...
            <p className="feature-subtitle">
              Divorce, custody, adoption, and family legal matters
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/family-law/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Family Law</h2>
          <p>Ready to streamline your family law?</p>
