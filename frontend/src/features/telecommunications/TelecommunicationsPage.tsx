...
const TelecommunicationsPage: React.FC = () => {
  const subFeatures = subFeaturesData['telecommunications'] || [];
    ...
    <div className="feature-page">
        ...
        <div className="container">
          <div className="feature-hero-content">
            ...
            <p className="feature-subtitle">
              Telecom regulatory matters and compliance
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/telecommunications/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Telecommunications</h2>
          <p>Ready to streamline your telecommunications?</p>
