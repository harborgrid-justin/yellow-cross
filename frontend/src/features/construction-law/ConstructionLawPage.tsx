...
const ConstructionLawPage: React.FC = () => {
  const subFeatures = subFeaturesData['construction-law'] || [];
    ...
    <div className="feature-page">
        ...
        <div className="container">
          <div className="feature-hero-content">
            ...
            <p className="feature-subtitle">
              Construction disputes and contract management
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/construction-law/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Construction Law</h2>
          <p>Ready to streamline your construction law?</p>
...
export default ConstructionLawPage;
