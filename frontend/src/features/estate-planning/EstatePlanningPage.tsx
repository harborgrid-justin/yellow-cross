...
const EstatePlanningPage: React.FC = () => {
  const subFeatures = subFeaturesData['estate-planning'] || [];
    ...
    <div className="feature-page">
      <div className="feature-hero">
        <div className="container">
          <div className="feature-hero-content">
            <i className="fas fa-file-signature feature-icon"></i>
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/estate-planning/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Estate Planning</h2>
          <p>Ready to streamline your estate planning?</p>
