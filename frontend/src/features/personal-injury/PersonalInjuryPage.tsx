...
const PersonalInjuryPage: React.FC = () => {
  const subFeatures = subFeaturesData['personal-injury'] || [];
    ...
    <div className="feature-page">
        ...
        <div className="container">
          <div className="feature-hero-content">
            ...
            <p className="feature-subtitle">
              Personal injury claims, settlements, and litigation
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/personal-injury/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Personal Injury</h2>
          <p>Ready to streamline your personal injury?</p>
