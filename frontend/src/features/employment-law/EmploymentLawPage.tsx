...
const EmploymentLawPage: React.FC = () => {
  const subFeatures = subFeaturesData['employment-law'] || [];
    ...
    <div className="feature-page">
        ...
        <div className="container">
          <div className="feature-hero-content">
            ...
            <p className="feature-subtitle">
              Employment disputes, contracts, and workplace investigations
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/employment-law/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Employment Law</h2>
          <p>Ready to streamline your employment law?</p>
