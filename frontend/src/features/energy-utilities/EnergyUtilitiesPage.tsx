    ...
    <div className="feature-page">
        ...
        <div className="container">
          <div className="feature-hero-content">
            ...
            <p className="feature-subtitle">
              Energy sector legal matters and regulations
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/energy-utilities/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Energy & Utilities</h2>
          <p>Ready to streamline your energy & utilities?</p>
