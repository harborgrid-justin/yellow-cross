...
const BankruptcyManagementPage: React.FC = () => {
  const subFeatures = subFeaturesData['bankruptcy-management'] || [];
    ...
    <div className="feature-page">
      <div className="feature-hero">
        <div className="container">
          <div className="feature-hero-content">
            ...
            <h1>Bankruptcy Management</h1>
            <p className="feature-subtitle">
              Bankruptcy filings, creditor management, and reorganization
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/bankruptcy-management/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Bankruptcy Management</h2>
          <p>Ready to streamline your bankruptcy management?</p>
...
export default BankruptcyManagementPage;
