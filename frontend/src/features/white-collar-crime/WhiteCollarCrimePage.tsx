...
const WhiteCollarCrimePage: React.FC = () => {
  const subFeatures = subFeaturesData['white-collar-crime'] || [];
    ...
    <div className="feature-page">
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/white-collar-crime/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with White Collar Crime</h2>
          <p>Ready to streamline your white collar crime?</p>
...
export default WhiteCollarCrimePage;
