...
const LaborRelationsPage: React.FC = () => {
  const subFeatures = subFeaturesData['labor-relations'] || [];
    ...
    <div className="feature-page">
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/labor-relations/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Labor Relations</h2>
          <p>Ready to streamline your labor relations?</p>
...
export default LaborRelationsPage;
