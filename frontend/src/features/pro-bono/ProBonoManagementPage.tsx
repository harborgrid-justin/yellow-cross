...
const ProBonoManagementPage: React.FC = () => {
  const subFeatures = subFeaturesData['pro-bono'] || [];
    ...
    <div className="feature-page">
      <div className="feature-hero">
        <div className="container">
          <div className="feature-hero-content">
            ...
            <h1>Pro Bono Management</h1>
            <p className="feature-subtitle">
              Pro bono legal services tracking and management
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/pro-bono/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Pro Bono Management</h2>
          <p>Ready to streamline your pro bono management?</p>
...
export default ProBonoManagementPage;
