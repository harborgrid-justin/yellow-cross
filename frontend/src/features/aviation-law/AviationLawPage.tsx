...
const AviationLawPage: React.FC = () => {
  const subFeatures = subFeaturesData['aviation-law'] || [];
    ...
    <div className="feature-page">
      <div className="feature-hero">
        <div className="container">
          <div className="feature-hero-content">
            <i className="fas fa-plane feature-icon"></i>
            <h1>Aviation Law</h1>
            <p className="feature-subtitle">
              Aviation regulations and incident investigations
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/aviation-law/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Aviation Law</h2>
          <p>Ready to streamline your aviation law?</p>
