...
const CorporateGovernancePage: React.FC = () => {
  const subFeatures = subFeaturesData['corporate-governance'] || [];
    ...
    <div className="feature-page">
        ...
        <div className="container">
          <div className="feature-hero-content">
            ...
            <p className="feature-subtitle">
              Corporate governance, compliance, and board management
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/corporate-governance/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Corporate Governance</h2>
          <p>Ready to streamline your corporate governance?</p>
