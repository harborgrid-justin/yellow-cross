    ...
    <div className="feature-page">
      <div className="feature-hero">
        <div className="container">
          <div className="feature-hero-content">
            ...
            <h1>Non-Profit Law</h1>
            <p className="feature-subtitle">
              Non-profit legal matters and 501(c)(3) compliance
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/non-profit-law/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Non-Profit Law</h2>
          <p>Ready to streamline your non-profit law?</p>
