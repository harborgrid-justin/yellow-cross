...
const SecurityPage: React.FC = () => {
  const subFeatures = subFeaturesData['security'] || [];
    ...
    <div className="feature-page">
        ...
        <div className="container">
          <div className="feature-hero-content">
            ...
            <p className="feature-subtitle">
              Comprehensive security & access control tools and features for your law firm
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/security/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Security & Access Control</h2>
          <p>Ready to streamline your security & access control?</p>
