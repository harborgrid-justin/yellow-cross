...
const SecuritiesLawPage: React.FC = () => {
  const subFeatures = subFeaturesData['securities-law'] || [];
    ...
    <div className="feature-page">
      <div className="feature-hero">
        <div className="container">
          <div className="feature-hero-content">
            ...
            <h1>Securities Law</h1>
            <p className="feature-subtitle">
              Securities law, SEC compliance, and investor protection
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/securities-law/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Securities Law</h2>
          <p>Ready to streamline your securities law?</p>
...
export default SecuritiesLawPage;
