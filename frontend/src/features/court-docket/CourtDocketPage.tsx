...
const CourtDocketPage: React.FC = () => {
  const subFeatures = subFeaturesData['court-docket'] || [];
    ...
    <div className="feature-page">
      <div className="feature-hero">
        <div className="container">
          <div className="feature-hero-content">
            ...
            <h1>Court & Docket Management</h1>
            <p className="feature-subtitle">
              Comprehensive court & docket management tools and features for your law firm
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/court-docket/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Court & Docket Management</h2>
          <p>Ready to streamline your court & docket management?</p>
...
export default CourtDocketPage;
