...
const EdiscoveryPage: React.FC = () => {
  const subFeatures = subFeaturesData['ediscovery'] || [];
    ...
    <div className="feature-page">
      <div className="feature-hero">
        <div className="container">
          <div className="feature-hero-content">
            ...
            <h1>eDiscovery & Evidence Management</h1>
            <p className="feature-subtitle">
              Comprehensive ediscovery & evidence management tools and features for your law firm
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/ediscovery/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with eDiscovery & Evidence Management</h2>
          <p>Ready to streamline your ediscovery & evidence management?</p>
