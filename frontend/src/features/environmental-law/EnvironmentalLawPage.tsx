...
const EnvironmentalLawPage: React.FC = () => {
  const subFeatures = subFeaturesData['environmental-law'] || [];
    ...
    <div className="feature-page">
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/environmental-law/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Environmental Law</h2>
          <p>Ready to streamline your environmental law?</p>
