...
const ConsumerProtectionPage: React.FC = () => {
  const subFeatures = subFeaturesData['consumer-protection'] || [];
    ...
    <div className="feature-page">
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/consumer-protection/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Consumer Protection</h2>
          <p>Ready to streamline your consumer protection?</p>
...
export default ConsumerProtectionPage;
