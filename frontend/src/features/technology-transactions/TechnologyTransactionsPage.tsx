...
const TechnologyTransactionsPage: React.FC = () => {
  const subFeatures = subFeaturesData['technology-transactions'] || [];
    ...
    <div className="feature-page">
      <div className="feature-hero">
        <div className="container">
          <div className="feature-hero-content">
            ...
            <h1>Technology Transactions</h1>
            <p className="feature-subtitle">
              Software licensing and tech transactions
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/technology-transactions/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Technology Transactions</h2>
          <p>Ready to streamline your technology transactions?</p>
...
export default TechnologyTransactionsPage;
