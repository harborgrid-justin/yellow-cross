...
const DocumentManagementPage: React.FC = () => {
  const subFeatures = subFeaturesData['document-management'] || [];
    ...
    <div className="feature-page">
      <div className="feature-hero">
        <div className="container">
          <div className="feature-hero-content">
            <i className="fas fa-folder-open feature-icon"></i>
            <h1>Document Management System</h1>
            <p className="feature-subtitle">
              Comprehensive document management system tools and features for your law firm
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/document-management/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Document Management System</h2>
          <p>Ready to streamline your document management system?</p>
