...
const InsuranceDefensePage: React.FC = () => {
  const subFeatures = subFeaturesData['insurance-defense'] || [];
    ...
    <div className="feature-page">
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/insurance-defense/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Insurance Defense</h2>
          <p>Ready to streamline your insurance defense?</p>
...
export default InsuranceDefensePage;
