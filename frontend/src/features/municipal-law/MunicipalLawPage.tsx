...
const MunicipalLawPage: React.FC = () => {
  const subFeatures = subFeaturesData['municipal-law'] || [];
    ...
    <div className="feature-page">
        ...
        <div className="container">
          <div className="feature-hero-content">
            ...
            <p className="feature-subtitle">
              Municipal government legal matters
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/municipal-law/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Municipal Law</h2>
          <p>Ready to streamline your municipal law?</p>
...
export default MunicipalLawPage;
