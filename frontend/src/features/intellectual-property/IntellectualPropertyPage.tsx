...
const IntellectualPropertyPage: React.FC = () => {
  const subFeatures = subFeaturesData['intellectual-property'] || [];
    ...
    <div className="feature-page">
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/intellectual-property/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Intellectual Property</h2>
          <p>Ready to streamline your intellectual property?</p>
