    ...
    <div className="feature-page">
        ...
        <div className="container">
          <div className="feature-hero-content">
            ...
            <p className="feature-subtitle">
              M&A deals, due diligence, and integration management
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/mergers-acquisitions/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Mergers & Acquisitions</h2>
          <p>Ready to streamline your mergers & acquisitions?</p>
