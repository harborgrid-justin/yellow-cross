...
const VeteransAffairsPage: React.FC = () => {
  const subFeatures = subFeaturesData['veterans-affairs'] || [];
    ...
    <div className="feature-page">
        ...
        <div className="container">
          <div className="feature-hero-content">
            ...
            <p className="feature-subtitle">
              Veterans benefits and legal assistance
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/veterans-affairs/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Veterans Affairs</h2>
          <p>Ready to streamline your veterans affairs?</p>
...
export default VeteransAffairsPage;
