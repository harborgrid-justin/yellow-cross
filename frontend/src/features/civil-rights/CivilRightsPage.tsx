...
const CivilRightsPage: React.FC = () => {
  const subFeatures = subFeaturesData['civil-rights'] || [];
    ...
    <div className="feature-page">
        ...
        <div className="container">
          <div className="feature-hero-content">
            ...
            <p className="feature-subtitle">
              Civil rights cases and discrimination matters
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/civil-rights/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Civil Rights</h2>
          <p>Ready to streamline your civil rights?</p>
