...
const RealEstateTransactionsPage: React.FC = () => {
  const subFeatures = subFeaturesData['real-estate-transactions'] || [];
    ...
    <div className="feature-page">
        ...
        <div className="container">
          <div className="feature-hero-content">
            ...
            <p className="feature-subtitle">
              Real estate transactions, closings, and title work
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/real-estate-transactions/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Real Estate Transactions</h2>
          <p>Ready to streamline your real estate transactions?</p>
...
export default RealEstateTransactionsPage;
