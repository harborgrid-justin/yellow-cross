...
const CriminalDefensePage: React.FC = () => {
  const subFeatures = subFeaturesData['criminal-defense'] || [];
    ...
    <div className="feature-page">
        ...
        <div className="container">
          <div className="feature-hero-content">
            ...
            <p className="feature-subtitle">
              Criminal defense case management and trial preparation
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/criminal-defense/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Criminal Defense</h2>
          <p>Ready to streamline your criminal defense?</p>
