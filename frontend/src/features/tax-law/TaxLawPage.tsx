...
const TaxLawPage: React.FC = () => {
  const subFeatures = subFeaturesData['tax-law'] || [];
    ...
    <div className="feature-page">
        ...
        <div className="container">
          <div className="feature-hero-content">
            ...
            <p className="feature-subtitle">
              Tax planning, disputes, and compliance
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/tax-law/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Tax Law</h2>
          <p>Ready to streamline your tax law?</p>
