...
const HealthcareLawPage: React.FC = () => {
  const subFeatures = subFeaturesData['healthcare-law'] || [];
    ...
    <div className="feature-page">
        ...
        <div className="container">
          <div className="feature-hero-content">
            ...
            <p className="feature-subtitle">
              Healthcare compliance, HIPAA, and medical malpractice
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/healthcare-law/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Healthcare Law</h2>
          <p>Ready to streamline your healthcare law?</p>
...
export default HealthcareLawPage;
