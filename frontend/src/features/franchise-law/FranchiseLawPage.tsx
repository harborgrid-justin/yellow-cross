...
const FranchiseLawPage: React.FC = () => {
  const subFeatures = subFeaturesData['franchise-law'] || [];
    ...
    <div className="feature-page">
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/franchise-law/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Franchise Law</h2>
          <p>Ready to streamline your franchise law?</p>
...
export default FranchiseLawPage;
