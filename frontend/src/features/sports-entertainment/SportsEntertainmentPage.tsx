    ...
    <div className="feature-page">
        ...
        <div className="container">
          <div className="feature-hero-content">
            ...
            <p className="feature-subtitle">
              Sports contracts and entertainment law
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/sports-entertainment/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Sports & Entertainment</h2>
          <p>Ready to streamline your sports & entertainment?</p>
