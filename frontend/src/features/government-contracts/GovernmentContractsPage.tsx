...
const GovernmentContractsPage: React.FC = () => {
  const subFeatures = subFeaturesData['government-contracts'] || [];
    ...
    <div className="feature-page">
      <div className="feature-hero">
        <div className="container">
          <div className="feature-hero-content">
            <i className="fas fa-landmark feature-icon"></i>
            <h1>Government Contracts</h1>
            <p className="feature-subtitle">
              Government contract management and compliance
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/government-contracts/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Government Contracts</h2>
          <p>Ready to streamline your government contracts?</p>
