...
const CalendarSchedulingPage: React.FC = () => {
  const subFeatures = subFeaturesData['calendar-scheduling'] || [];
    ...
    <div className="feature-page">
        ...
        <div className="container">
          <div className="feature-hero-content">
            ...
            <p className="feature-subtitle">
              Comprehensive calendar & scheduling system tools and features for your law firm
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/calendar-scheduling/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Calendar & Scheduling System</h2>
          <p>Ready to streamline your calendar & scheduling system?</p>
