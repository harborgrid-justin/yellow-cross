...
const InternationalTradePage: React.FC = () => {
  const subFeatures = subFeaturesData['international-trade'] || [];
    ...
    <div className="feature-page">
        ...
        <div className="container">
          <div className="feature-hero-content">
            ...
            <p className="feature-subtitle">
              International trade compliance and customs
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/international-trade/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with International Trade</h2>
          <p>Ready to streamline your international trade?</p>
