...
const ImmigrationLawPage: React.FC = () => {
  const subFeatures = subFeaturesData['immigration-law'] || [];
    ...
    <div className="feature-page">
      <div className="feature-hero">
        <div className="container">
          <div className="feature-hero-content">
            <i className="fas fa-passport feature-icon"></i>
            <h1>Immigration Law</h1>
            <p className="feature-subtitle">
              Immigration cases, visa applications, and citizenship matters
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <section className="sub-features-section">
          ...
          <div className="sub-features-grid">
            {subFeatures.map((subFeature) => (
              <Link
                key={subFeature.id}
                to={`/features/immigration-law/${subFeature.slug}`}
        ...
        <section className="feature-cta">
          <h2>Get Started with Immigration Law</h2>
          <p>Ready to streamline your immigration law?</p>
