describe('Integration System - Comprehensive Test Suite', () => {
  // Note: Integration System pages are protected by authentication
  ...
  describe('Authentication and Access Control', () => {
    ...
    it('should protect integration route with authentication', () => {
      cy.visit('/features/integration');
      cy.url().should('include', '/login');
    });
  ...
  describe('Sub-Feature Route Protection', () => {
    it('should protect api-management sub-feature route', () => {
      cy.visit('/features/integration/api-management');
      cy.url().should('include', '/login');
    });
    it('should protect third-party sub-feature route', () => {
      cy.visit('/features/integration/third-party');
      cy.url().should('include', '/login');
    });
    it('should protect data-sync sub-feature route', () => {
      cy.visit('/features/integration/data-sync');
      cy.url().should('include', '/login');
    });
    it('should protect webhooks sub-feature route', () => {
      cy.visit('/features/integration/webhooks');
      cy.url().should('include', '/login');
    });
    it('should protect sso sub-feature route', () => {
      cy.visit('/features/integration/sso');
      cy.url().should('include', '/login');
    });
    it('should protect calendar-sync sub-feature route', () => {
      cy.visit('/features/integration/calendar-sync');
      cy.url().should('include', '/login');
    });
    it('should protect email-sync sub-feature route', () => {
      cy.visit('/features/integration/email-sync');
      cy.url().should('include', '/login');
    });
    it('should protect accounting-integration sub-feature route', () => {
      cy.visit('/features/integration/accounting-integration');
      cy.url().should('include', '/login');
    });
  });
  ...
  // ============================================================================
  // API and Third-Party Tests (15 tests)
  // ============================================================================
  describe('API and Third-Party Tests', () => {
    it('should protect api-management route', () => {
      cy.visit('/features/integration/api-management/route');
      cy.url().should('include', '/login');
    });
    it('should protect third-party list', () => {
      cy.visit('/features/integration/third-party/list');
      cy.url().should('include', '/login');
    });
    it('should protect data-sync create', () => {
      cy.visit('/features/integration/data-sync/create');
      cy.url().should('include', '/login');
    });
    it('should protect webhooks edit', () => {
      cy.visit('/features/integration/webhooks/edit');
      cy.url().should('include', '/login');
    });
    it('should protect sso delete', () => {
      cy.visit('/features/integration/sso/delete');
      cy.url().should('include', '/login');
    });
    it('should protect calendar-sync view', () => {
      cy.visit('/features/integration/calendar-sync/view');
      cy.url().should('include', '/login');
    });
    it('should protect email-sync search', () => {
      cy.visit('/features/integration/email-sync/search');
      cy.url().should('include', '/login');
    });
    it('should protect accounting-integration filter', () => {
      cy.visit('/features/integration/accounting-integration/filter');
      cy.url().should('include', '/login');
    });
    it('should protect api-management export', () => {
      cy.visit('/features/integration/api-management/export');
      cy.url().should('include', '/login');
    });
    it('should protect third-party settings', () => {
      cy.visit('/features/integration/third-party/settings');
      cy.url().should('include', '/login');
    });
    it('should protect data-sync history', () => {
      cy.visit('/features/integration/data-sync/history');
      cy.url().should('include', '/login');
    });
    it('should protect webhooks analytics', () => {
      cy.visit('/features/integration/webhooks/analytics');
      cy.url().should('include', '/login');
    });
    it('should protect sso reports', () => {
      cy.visit('/features/integration/sso/reports');
      cy.url().should('include', '/login');
    });
    it('should protect calendar-sync alerts', () => {
      cy.visit('/features/integration/calendar-sync/alerts');
      cy.url().should('include', '/login');
    });
    it('should protect email-sync permissions', () => {
      cy.visit('/features/integration/email-sync/permissions');
      cy.url().should('include', '/login');
    });
  });

  // ============================================================================
  // Sync and SSO Tests (18 tests)
  // ============================================================================
  describe('Sync and SSO Tests', () => {
    it('should protect api-management route', () => {
      cy.visit('/features/integration/api-management/route');
      cy.url().should('include', '/login');
    });
    ...
    it('should protect accounting-integration route', () => {
      cy.visit('/features/integration/accounting-integration/route');
      cy.url().should('include', '/login');
    });
    it('should protect api-management list', () => {
      cy.visit('/features/integration/api-management/list');
      cy.url().should('include', '/login');
    });
    it('should protect third-party create', () => {
      cy.visit('/features/integration/third-party/create');
      cy.url().should('include', '/login');
    });
  });

  // ============================================================================
  // Integration Management Tests (8 tests)
  // ============================================================================
