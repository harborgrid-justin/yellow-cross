describe('eDiscovery & Evidence Management - Comprehensive Test Suite', () => {
  // Note: eDiscovery pages are protected by authentication
  ...
  describe('Authentication and Access Control', () => {
    ...
    it('should protect ediscovery route with authentication', () => {
      cy.visit('/features/ediscovery');
      cy.url().should('include', '/login');
    });
  ...
  describe('Sub-Feature Route Protection', () => {
    it('should protect data-collection sub-feature route', () => {
      cy.visit('/features/ediscovery/data-collection');
      cy.url().should('include', '/login');
    });

    it('should protect review-platform sub-feature route', () => {
      cy.visit('/features/ediscovery/review-platform');
      cy.url().should('include', '/login');
    });

    it('should protect legal-hold sub-feature route', () => {
      cy.visit('/features/ediscovery/legal-hold');
      cy.url().should('include', '/login');
    });

    it('should protect production-management sub-feature route', () => {
      cy.visit('/features/ediscovery/production-management');
      cy.url().should('include', '/login');
    });

    it('should protect privilege-review sub-feature route', () => {
      cy.visit('/features/ediscovery/privilege-review');
      cy.url().should('include', '/login');
    });

    it('should protect evidence-organization sub-feature route', () => {
      cy.visit('/features/ediscovery/evidence-organization');
      cy.url().should('include', '/login');
    });

    it('should protect analytics-tar sub-feature route', () => {
      cy.visit('/features/ediscovery/analytics-tar');
      cy.url().should('include', '/login');
    });

    it('should protect ediscovery-reporting sub-feature route', () => {
      cy.visit('/features/ediscovery/ediscovery-reporting');
      cy.url().should('include', '/login');
    });
  });
  ...
  describe('Security and Data Protection', () => {
    it('should require authentication for all ediscovery routes', () => {
      const routes = [
        '/features/ediscovery',
    ...
    it('should protect against unauthorized access', () => {
      cy.visit('/features/ediscovery');
      cy.url().should('not.include', '/features/ediscovery');
      cy.url().should('include', '/login');
    });
