describe('Client Relationship Management - Comprehensive Test Suite', () => {
  // Note: Client CRM pages are protected by authentication
  // These tests verify the authentication flow, security, routing, and UX
  
  beforeEach(() => {
    cy.visit('/features/client-crm');
  });
  ...
  describe('Authentication and Access Control', () => {
    ...
    it('should protect client CRM route with authentication', () => {
      cy.visit('/features/client-crm');
      cy.url().should('include', '/login');
    });
  ...
  describe('Sub-Feature Route Protection', () => {
    it('should protect database-management sub-feature route', () => {
      cy.visit('/features/client-crm/database-management');
      cy.url().should('include', '/login');
    });

    it('should protect communication-history sub-feature route', () => {
      cy.visit('/features/client-crm/communication-history');
      cy.url().should('include', '/login');
    });

    it('should protect portal-access sub-feature route', () => {
      cy.visit('/features/client-crm/portal-access');
      cy.url().should('include', '/login');
    });

    it('should protect intake-onboarding sub-feature route', () => {
      cy.visit('/features/client-crm/intake-onboarding');
      cy.url().should('include', '/login');
    });

    it('should protect billing-information sub-feature route', () => {
      cy.visit('/features/client-crm/billing-information');
      cy.url().should('include', '/login');
    });

    it('should protect conflict-checking sub-feature route', () => {
      cy.visit('/features/client-crm/conflict-checking');
      cy.url().should('include', '/login');
    });

    it('should protect retention-feedback sub-feature route', () => {
      cy.visit('/features/client-crm/retention-feedback');
      cy.url().should('include', '/login');
    });

    it('should protect relationship-analytics sub-feature route', () => {
      cy.visit('/features/client-crm/relationship-analytics');
      cy.url().should('include', '/login');
    });
  });
  ...
  describe('Footer Content', () => {
    ...
    it('should have Features section listing Client CRM', () => {
      cy.get('footer').contains('Features').should('be.visible');
      cy.get('footer').contains('Client Relationship Management').should('be.visible');
    });
  ...
  describe('Form Interaction and State Management', () => {
    it('should maintain email value when switching fields', () => {
      const testEmail = 'client@lawfirm.com';
  ...
  describe('URL and Route Handling', () => {
    it('should handle client-crm URL correctly', () => {
      cy.visit('/features/client-crm');
      cy.url().should('include', '/login');
    });
    ...
    it('should handle case-insensitive URL variations', () => {
      cy.visit('/features/Client-CRM', { failOnStatusCode: false });
      cy.url().should('exist');
    });
  ...
  describe('Security and Data Protection', () => {
    it('should require authentication for all client CRM routes', () => {
      const routes = [
        '/features/client-crm',
    ...
    it('should protect against unauthorized access', () => {
      cy.visit('/features/client-crm');
      cy.url().should('not.include', '/features/client-crm');
      cy.url().should('include', '/login');
    });
