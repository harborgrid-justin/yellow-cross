describe('Security System - Comprehensive Test Suite', () => {
  // Note: Security System pages are protected by authentication
  ...
  describe('Authentication and Access Control', () => {
    ...
    it('should protect security route with authentication', () => {
      cy.visit('/features/security');
      cy.url().should('include', '/login');
    });
  ...
  describe('Sub-Feature Route Protection', () => {
    it('should protect access-control sub-feature route', () => {
      cy.visit('/features/security/access-control');
      cy.url().should('include', '/login');
    });
    it('should protect encryption sub-feature route', () => {
      cy.visit('/features/security/encryption');
      cy.url().should('include', '/login');
    });
    it('should protect audit-logs sub-feature route', () => {
      cy.visit('/features/security/audit-logs');
      cy.url().should('include', '/login');
    });
    it('should protect two-factor-auth sub-feature route', () => {
      cy.visit('/features/security/two-factor-auth');
      cy.url().should('include', '/login');
    });
    it('should protect password-policy sub-feature route', () => {
      cy.visit('/features/security/password-policy');
      cy.url().should('include', '/login');
    });
    it('should protect data-protection sub-feature route', () => {
      cy.visit('/features/security/data-protection');
      cy.url().should('include', '/login');
    });
    it('should protect compliance-security sub-feature route', () => {
      cy.visit('/features/security/compliance-security');
      cy.url().should('include', '/login');
    });
    it('should protect threat-detection sub-feature route', () => {
      cy.visit('/features/security/threat-detection');
      cy.url().should('include', '/login');
    });
  });
  ...
  describe('URL and Route Handling', () => {
    ...
    it('should handle case-insensitive URL variations', () => {
      cy.visit('/features/Security', { failOnStatusCode: false });
      cy.url().should('exist');
    });
  ...
  describe('Security and Data Protection', () => {{
    ...
    it('should protect against unauthorized access', () => {{
      cy.visit('/features/security');
      cy.url().should('not.include', '/features/security');
      cy.url().should('include', '/login');
    }});
  ...
  // ============================================================================
  // Access Control and Authentication Tests (15 tests)
  // ============================================================================
  describe('Access Control and Authentication Tests', () => {
    it('should protect access-control route', () => {
      cy.visit('/features/security/access-control/route');
      cy.url().should('include', '/login');
    });
    it('should protect encryption list', () => {
      cy.visit('/features/security/encryption/list');
      cy.url().should('include', '/login');
    });
    it('should protect audit-logs create', () => {
      cy.visit('/features/security/audit-logs/create');
      cy.url().should('include', '/login');
    });
    it('should protect two-factor-auth edit', () => {
      cy.visit('/features/security/two-factor-auth/edit');
      cy.url().should('include', '/login');
    });
    it('should protect password-policy delete', () => {
      cy.visit('/features/security/password-policy/delete');
      cy.url().should('include', '/login');
    });
    it('should protect data-protection view', () => {
      cy.visit('/features/security/data-protection/view');
      cy.url().should('include', '/login');
    });
    it('should protect compliance-security search', () => {
      cy.visit('/features/security/compliance-security/search');
      cy.url().should('include', '/login');
    });
    it('should protect threat-detection filter', () => {
      cy.visit('/features/security/threat-detection/filter');
      cy.url().should('include', '/login');
    });
    it('should protect access-control export', () => {
      cy.visit('/features/security/access-control/export');
      cy.url().should('include', '/login');
    });
    it('should protect encryption settings', () => {
      cy.visit('/features/security/encryption/settings');
      cy.url().should('include', '/login');
    });
    it('should protect audit-logs history', () => {
      cy.visit('/features/security/audit-logs/history');
      cy.url().should('include', '/login');
    });
    it('should protect two-factor-auth analytics', () => {
      cy.visit('/features/security/two-factor-auth/analytics');
      cy.url().should('include', '/login');
    });
    it('should protect password-policy reports', () => {
      cy.visit('/features/security/password-policy/reports');
      cy.url().should('include', '/login');
    });
    it('should protect data-protection alerts', () => {
      cy.visit('/features/security/data-protection/alerts');
      cy.url().should('include', '/login');
    });
    it('should protect compliance-security permissions', () => {
      cy.visit('/features/security/compliance-security/permissions');
      cy.url().should('include', '/login');
    });
  });

  // ============================================================================
  // Encryption and Data Protection Tests (18 tests)
  // ============================================================================
  describe('Encryption and Data Protection Tests', () => {
    it('should protect access-control route', () => {
      cy.visit('/features/security/access-control/route');
      cy.url().should('include', '/login');
    });
    ...
    it('should protect threat-detection route', () => {
      cy.visit('/features/security/threat-detection/route');
      cy.url().should('include', '/login');
    });
    it('should protect access-control list', () => {
      cy.visit('/features/security/access-control/list');
      cy.url().should('include', '/login');
    });
    it('should protect encryption create', () => {
      cy.visit('/features/security/encryption/create');
      cy.url().should('include', '/login');
    });
  });

  // ============================================================================
  // Audit and Compliance Tests (8 tests)
  // ============================================================================
